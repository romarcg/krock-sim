...
void light_sensorCallback(const sensor_msgs::Illuminance::ConstPtr& value) {
...
int main(int argc, char **argv) {
  ...
  if (get_number_of_devices_client.call(get_number_of_devices_srv)) {
    number_of_devices = get_number_of_devices_srv.response.value;
  ...
  if (get_basic_time_step_client.call(get_basic_time_step_srv)) {
    basic_time_step = get_basic_time_step_srv.response.value;
  ...
  if (get_synchronization_client.call(get_synchronization_srv)) {
    synchronization = get_synchronization_srv.response.value;
    if (synchronization)
  ...
  if (get_time_client.call(get_time_srv)) {
    time = get_time_srv.response.value;
  ...
  if (get_type_client.call(get_type_srv)) {
    type = get_type_srv.response.value;
  ...
  ros::ServiceClient brake_set_client = n.serviceClient<webots_ros::set_float>(model_name+"/brake/set_damping_constant");
  ...
  ROS_INFO("Accelerometer is enable with a sampling period of %d.",sampling_period_accelerometer_srv.response.value);
  ...
  ROS_INFO("Battery_sensor is enable with a sampling period of %d.", sampling_period_battery_sensor_srv.response.value);
  ...
  ROS_INFO("Compass is enable with a sampling period of %d.", sampling_period_compass_srv.response.value);
  ...
  ROS_INFO("Distance_sensor is enable with a sampling period of %d.", sampling_period_distance_sensor_srv.response.value);
  ...
  ROS_INFO("GPS is enable with a sampling period of %d.", sampling_period_GPS_srv.response.value);
  ...
  ROS_INFO("Gyro is enable with a sampling period of %d.", sampling_period_gyro_srv.response.value);
  ...
  ROS_INFO("Inertial_unit is enable with a sampling period of %d.", sampling_period_inertial_unit_srv.response.value);
  ...
  if (set_light_sensor_client.call(light_sensor_srv) && light_sensor_srv.response.success) {
    ...
    sub_light_sensor_32 = n.subscribe(model_name+"/light_sensor/value", 1, light_sensorCallback);
  ...
  ROS_INFO("Light_sensor is enable with a sampling period of %d.", sampling_period_light_sensor_srv.response.value);
  ...
  ROS_INFO("Position_sensor is enable with a sampling period of %d.", sampling_period_position_sensor_srv.response.value);
  ...
  ROS_INFO("Receiver is enable with a sampling period of %d.", sampling_period_receiver_srv.response.value);
  ...
  ROS_INFO("Touch_sensor is enable with a sampling period of %d.", sampling_period_touch_sensor_srv.response.value);
  ...
  webots_ros::get_int supervisor_get_root_srv;
  supervisor_get_root_client = n.serviceClient<webots_ros::get_int>(model_name+"/supervisor/get_root");

  supervisor_get_root_client.call(supervisor_get_root_srv);
  ROS_INFO("Got root node: %d.",supervisor_get_root_srv.response.value);
  ...
  webots_ros::get_int supervisor_get_self_srv;
  supervisor_get_self_client = n.serviceClient<webots_ros::get_int>(model_name+"/supervisor/get_self");

  supervisor_get_self_client.call(supervisor_get_self_srv);
  ROS_INFO("Got self node: %d.", supervisor_get_self_srv.response.value);
  ...
  int cone_node;
  if (supervisor_get_from_def_srv.response.node != 0) {
    ROS_INFO("Got CONE node from DEF: %ld.", supervisor_get_from_def_srv.response.node);
  ...
  int cone_node_copy = supervisor_get_from_id_srv.response.node;
  ...
  bool s = remove_node_client.call(node_remove_srv);
